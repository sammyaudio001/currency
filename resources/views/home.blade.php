...
<div class="container mt-5">
   ...
   Currency converter
    ...
    <div class="card-body">
    <form id="currency-exchange-rate" action="{{route('currency_post')}}"  class="form-group">
        @csrf
        @method('POST')
    <div class="row mb-3">
    <div class="col-md-4">
    ...
    <div class="row">
    <div class="col-md-4">
    <input type="submit" name="submit" id="btnSubmit" class="btn btn-primary " value="Calculate">
    </div>
    </div>
    </form>
    </div>
